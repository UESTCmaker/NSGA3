...
FListPtr Sort_Population(individualPtr *pop)
{
    ...
    ListPtr newpop=NULL,LastFront=NULL,AssociateFromLastFront=NULL,NumList=NULL,Numl=NULL,LastF=NULL,AssociateF=NULL,pFT=NULL;
    individualPtr p = *pop;
    ...
    */
    ...
    while(number_List(newpop)<input.nPop_Old)
    {
        if(!Numl)
        {
            Numl=NumList;
